...
<template>
    ...
    <main>
        ...
        <h2 class="subtitle">Hola, estoy probando scss</h2>
        <p>Para instalarlo: npm add -D sass</p>
        <p class="parrafo">Y en los style hay que agregar: lang="scss" <span class="parrafo-child">Probando span</span>
        </p>
    </main>

    <!-- PROBANDO CodePen Home Steam inspired game card hover effect -->
    <section>
